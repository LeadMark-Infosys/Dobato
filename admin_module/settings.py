...
SECRET_KEY = "_=d=@cuyb@@=5qccq+*jh@#!@-4w55l_fou+)gm_up-i7yf#vm"
...
MIDDLEWARE = [
    ...
    "apps.cms.middleware.SlugHistoryMiddleware",
]
REST_FRAMEWORK = {
...
CELERY_BEAT_SCHEDULE = {
    "cms-scheduled-publish-unpublish": {
        "task": "cms.publish_unpublish_scheduled_pages",
        "schedule": crontab(),
    },
}
